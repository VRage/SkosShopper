package Skos.SkosBrowser.org.coode.html.util;

import org.apache.log4j.Logger;

import Skos.SkosBrowser.org.coode.html.impl.OWLHTMLConstants;
import Skos.SkosBrowser.org.coode.html.impl.OWLHTMLParam;
...
public class URLUtils {
    ...
    public static String createRelativeURL(URL current, URL target) {
        ...
        try{
        	...
        	logger.warn("Exception caught creating file name for url " + target + " using a base url of " + current);
        }
